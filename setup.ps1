...
if (!(Test-Path -Path $PROFILE -PathType Leaf)) {
    try {
        ...
        Invoke-RestMethod https://raw.githubusercontent.com/FATC0RK/powershell-profile/refs/heads/add-install-functionality/Microsoft.PowerShell_profile.ps1 -OutFile $PROFILE
